      ...
      <div className="doc-grid">
        ...
        <table className="doc-table">
          ...
          <tbody>
            ...
            {Array.from({ length: emptyRows }).map((_, i) => <tr key={`empty-${i}`} className="doc-empty-row"><td colSpan={6} /></tr>)}
          </tbody>
        </table>
        ...
        <div className="doc-bottom-area">
          <div className="doc-payment-notes">
            <div className="doc-note-box">
              ...
              <p>Transfer Rek BCA 0153795786 a.n Yuliasih Setiati<br />Transfer Rek BRI 033401014826532 a.n Yuli Asih Setiati</p>
            </div>
            <div className="doc-note-box">
